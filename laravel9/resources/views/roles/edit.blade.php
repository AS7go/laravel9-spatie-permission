            ...
            <div class="col-md-12">
                ...
                <form method="post" action="{{route('roles.update',$role->id)}}">
                    ...
                    <div class="form-group">
                        <label for="exampleInputEmail1" class="text-gray-800 dark:text-gray-200 leading-tight">Title</label>
                    ...
                    @foreach ($permissions as $permission)
                        <div class="form-group form-check">
                            ...
                            <label class="form-check-label" for="exampleCheck{{$permission->id}}" style="color: white;">{{$permission->name}}</label>
                        </div> 
                    @endforeach
